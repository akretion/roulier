        ...
        body = dict(
            ShipmentRequest=dict(
                LabelSpecification=dict(
                    ...
                    LabelStockSize=dict(Height="6", Width="4",),
                ),
                Shipment=dict(
                    ...
                    Shipper=dict(
                        ...
                        Address=dict(
                            AddressLine=[
                                from_address.get("street1"),
                                from_address.get("street2"),
                            ],
                    ...
                    ShipTo=dict(
                        ...
                        Address=dict(
                            AddressLine=[
                                to_address.get("street1"),
                                to_address.get("street2"),
                            ],
                    ...
                    Service=dict(Code=data.get("service").get("product"),),
                    Package=[
                        dict(
                            ReferenceNumber=dict(Value=package.get("reference"),),
