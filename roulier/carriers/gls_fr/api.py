...
class GlsApi(Api):
    ...
    def _auth(self):
        schema = super(GlsApi, self)._auth()
        # contact_id
        schema["login"].update(
            {"required": True, "empty": False, "maxlength": 10})
    ...
    def _service(self):
        ...
        schema["parcel_total_number"] = {
            "max": 999, "type": "integer", "required": True}
        return schema
    ...
    def _to_address(self):
        ...
        schema["consignee_name"] = {"maxlength": 35, "required": True}
        ...
        schema["country_code"] = {
            "minlength": 2, "maxlength": 2, "type": "string"}
